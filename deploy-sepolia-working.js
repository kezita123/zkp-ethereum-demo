...
async function main() {
    ...
    // CORRECTED Alchemy URL (notice the API key: 5oDgMdzw6MSljigJ, not 50g...)
    const alchemyUrl = "https://eth-sepolia.g.alchemy.com/v2/jzrb-5oDgMdzw6MSljigJ";
    ...
    try {
        ...
        console.log("❌ Cannot connect to Alchemy. Check your internet connection.");
